                ...
                <View style={GlobalStyles.container}>
                            ...
                            <>
                                {
                                    ...
                                    <View style={{ flex: 1, flexDirection: 'column', justifyContent: "space-evenly", alignItems: "center" }}>
                                        <Pressable style={[GlobalStyles.buttonStylePay]} onPress={() => {
                                            this.setState({
                                                method: 2
                                            })
                                        }}>
                                            <Image source={QR} alt="Cat" style={{ width: 32 * 1.3, height: 26 * 1.3 }} />
                                            <Text style={{ color: "white", fontSize: 24, fontWeight: "bold", paddingTop: 2 }}>
                                                Solana Pay
                                            </Text>
                                        </Pressable>
                                        <Pressable style={[GlobalStyles.buttonStylePay]} onPress={() => {
                                ...
                                {
                                    this.state.method === 2 &&
                                    <SolanaPay callback={() => this.setState({
                                        method: 0
                                    })} />
                                }
                                {
                    ...
                    <View style={GlobalStyles.footer}>
                        <Pressable style={[this.state.selectorSytle1, { alignItems: "center" }]}
                            ...
                            <Icon name="payments" size={24} color={this.state.number === 0 ? "black" : "white"} />
                        ...
                        <Pressable style={[this.state.selectorSytle2, { alignItems: "center" }]}
                            ...
                            <Image source={this.state.number === 1 ? QR : QRinv} alt="Cat" style={{ width: 32 * 0.8, height: 26 * 0.8 }} />
                        ...
                        <Pressable style={[this.state.selectorSytle3, { alignItems: "center" }]}
                            ...
                            <Icon name="account-balance-wallet" size={24} color={this.state.number === 2 ? "black" : "white"} />
